...
// @access  Private
// NOTE: This MUST be defined BEFORE /:id to prevent Express matching "track" as an :id param
...
router.post('/', protect, [
  ...
  try {
    ...
    // Create order — orderNumber is auto-generated by the pre('save') hook in Order.js
